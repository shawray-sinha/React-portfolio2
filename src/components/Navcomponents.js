...
export function Home(){
    return(
        <section style={{padding:"10px 0px",backgroundColor:"beige"}} id="Home">
                ...
                <div className="row justify-content-center bg-info">
                    <div className="col-lg-10" id="back">
                        ...
                        <div className="text-center text-light" id="back-text">
                            <h1>Hi! There, I'm Shawray Sinha</h1>
            ...
            <div class="container-lg">
                <div class="row justify-content-center align-item-center">
                    <div class="col-md-5 text-center text-md-start border border-secondary" style={{backgroundColor: "rgb(214, 213, 213)"}}>
                        <h1>
                            <div class="display-4">Shawray Sinha</div>
                        ...
                        <div class="contact">
                            ...
                            <span class="lead"><i class="bi bi-envelope-at-fill"></i> How to reach me : 
                                <a href="mailto:shawray.sinha2021@vitstudent.ac.in" class="btn btn-sm btn-primary fw-bold">Email</a>
                            </span>
                            <br /><br />
                            ...
                            <p class="btn-group">
                                <a href="https://www.linkedin.com/in/567990214/" target="_blank" class="btn btn-sm btn-success fw-bold"><i class="bi bi-linkedin"></i> Linked In</a>
                                <a href="https://github.com/Shawray-sinha" target="_blank" class="btn btn-warning btn-sm fw-bold"><i class="bi bi-github"></i> GitHub</a>
                                <a href="https://google.com/file/d/13PJmJX2qgCulus0_UkzIs7bRiTztU5M7/view?usp=drivesdk " target="_blank" class="btn btn-sm btn-danger fw-bold">Resume </a>
                            </p>
                    ...
                    <div class="col-md-5 text-center d-none d-md-block">
                        <span class="tt" data-bs-placement="bottom" title="SHAWRAY">
                    ...
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-info border-2">
                            ...
                            <div class="card-body text-center py-4">
                                ...
                                <a href="https://github.com/TaskBS" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-8 col-lg-4 col-xl-3">
                    ...
                    <div class="col-lg-6">
                        <form action="">
                            ...
                            <div class="mb-4 input-group">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="e.g. Shawray Sinha" required/>
